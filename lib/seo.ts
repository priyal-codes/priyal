  ...
  return {
    ...
    hasPart: [
      ...
      },
      {
        ...
        name: "Priyal Ramteke Resume PDF",
  ...
  const siteLinks = [
    {
      name: "Projects & Selected Works",
      description:
        "Explore full-stack web applications, real-time streaming apps, and open-source GitHub repositories created by Priyal Ramteke.",
      url: `${baseUrl}/projects`,
    },
    {
      name: "Blog & Technical Articles",
      description:
        "Read technical articles and insights on full-stack development, React, Node.js, and real-time systems.",
      url: `${baseUrl}/blogs`,
    },
    {
      name: "Resume & Curriculum Vitae",
      description:
        "Professional background, technical skills, education, and career experience of Priyal Ramteke.",
      url: `${baseUrl}/resume`,
    },
    {
      name: "Direct Resume PDF",
      description:
        "Direct view and download of the official resume PDF of Priyal Ramteke.",
