...
export const HUMAN_LICENSE_SUMMARY: {
  ...
  terms: {
    ...
    items: [
      ...
      "No trademark rights granted to Priyal Ramteke's name, logo, or brand identity.",
    ],
  },
};
...
Copyright (c) 2026 Priyal Ramteke
...
(collectively, the "Software"), authored and owned by Priyal Ramteke
(the "Author").
